    ...
    return (
        <div className="auth-container">
            <div className="auth-card">
                <h2 className="auth-title">{t('confirm.title')}</h2>

                {status === 'loading' && <p>{t('confirm.verifying')}</p>}
                ...
                {status === 'success' && (
                    <>
                        ...
                        <Link to="/signin" className="auth-link">{t('confirm.signin')}</Link>
                    </>
                )}
                ...
                {status === 'error' && (
                    <>
                        ...
                        <Link to="/signup" className="auth-link">{t('confirm.retrySignup')}</Link>
                    </>
                )}
            </div>
        </div>
