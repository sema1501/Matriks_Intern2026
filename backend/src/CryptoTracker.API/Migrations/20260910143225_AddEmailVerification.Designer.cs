...
namespace CryptoTracker.API.Migrations
{
    ...
    [Migration("20260910143225_AddEmailVerification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoTracker.API.Models.BotSignal", b =>
                {
                    ...
                    b.Property<decimal>("RsiValueAtSignal")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("CryptoTracker.API.Models.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoTracker.API.Models.PriceAlert", b =>
                {
                    ...
                    b.Property<decimal?>("PercentChangeThreshold")
                        .HasPrecision(9, 4)
            ...
            modelBuilder.Entity("CryptoTracker.API.Models.TradingBot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("BuyRsiThreshold")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("CryptoTracker.API.Models.BotSignal", b =>
                {
                    b.HasOne("CryptoTracker.API.Models.TradingBot", "Bot")
                        .WithMany("Signals")
                        .HasForeignKey("BotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
